...
namespace TunifyPlatform.Migrations
{
    ...
    [Migration("20240805091609_SeedInitialData")]
            ...
            modelBuilder.Entity("TunifyPlatform.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 8, 5, 12, 16, 9, 416, DateTimeKind.Local).AddTicks(5557),
                            SubscriptionId = 1,
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 7, 26, 12, 16, 9, 416, DateTimeKind.Local).AddTicks(5569),
                            SubscriptionId = 1,
                            Username = "user1"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 7, 16, 12, 16, 9, 416, DateTimeKind.Local).AddTicks(5576),
                            SubscriptionId = 2,
                            Username = "user2"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 7, 6, 12, 16, 9, 416, DateTimeKind.Local).AddTicks(5577),
                            SubscriptionId = 2,
                            Username = "user3"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 6, 26, 12, 16, 9, 416, DateTimeKind.Local).AddTicks(5578),
                            SubscriptionId = 1,
                            Username = "user4"
                        });
                });
