...
namespace TunifyPlatform.Migrations
{
    ...
    [Migration("20240817064023_UpdDBContext")]
    partial class UpdDBContext
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TunifyPlatform.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 8, 17, 9, 40, 22, 917, DateTimeKind.Local).AddTicks(8334),
                            SubscriptionId = 1,
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 8, 7, 9, 40, 22, 917, DateTimeKind.Local).AddTicks(8345),
                            SubscriptionId = 1,
                            Username = "user1"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 7, 28, 9, 40, 22, 917, DateTimeKind.Local).AddTicks(8352),
                            SubscriptionId = 2,
                            Username = "user2"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 7, 18, 9, 40, 22, 917, DateTimeKind.Local).AddTicks(8353),
                            SubscriptionId = 2,
                            Username = "user3"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 7, 8, 9, 40, 22, 917, DateTimeKind.Local).AddTicks(8355),
                            SubscriptionId = 1,
                            Username = "user4"
                        });
                });
