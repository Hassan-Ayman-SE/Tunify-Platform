...
namespace TunifyPlatform.Migrations
{
    ...
    [Migration("20240827113010_addRoles")]
            ...
            modelBuilder.Entity("TunifyPlatform.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 8, 27, 14, 30, 10, 328, DateTimeKind.Local).AddTicks(4473),
                            SubscriptionId = 1,
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 8, 17, 14, 30, 10, 328, DateTimeKind.Local).AddTicks(4492),
                            SubscriptionId = 1,
                            Username = "user1"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 8, 7, 14, 30, 10, 328, DateTimeKind.Local).AddTicks(4500),
                            SubscriptionId = 2,
                            Username = "user2"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 7, 28, 14, 30, 10, 328, DateTimeKind.Local).AddTicks(4502),
                            SubscriptionId = 2,
                            Username = "user3"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 7, 18, 14, 30, 10, 328, DateTimeKind.Local).AddTicks(4504),
                            SubscriptionId = 1,
                            Username = "user4"
                        });
                });
